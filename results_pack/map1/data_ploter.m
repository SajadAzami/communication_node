...
direct_mean_of_data=reshape(direct_mean_of_data,[5,15]);
direct_standard_deviation = std(direct_data_table,0,2);
direct_standard_deviation=reshape(direct_standard_deviation,[5,15]);
...
osm_standard_deviation=reshape(osm_standard_deviation,[5,15]);
...
swm_mean_of_data=reshape(swm_mean_of_data,[5,15]);
swm_standard_deviation = std(swm_data_table,0,2);
swm_standard_deviation=reshape(swm_standard_deviation,[5,15]);
